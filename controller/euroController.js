...
class euroController {
    ...
    getEuroNacion = async (_req, res) => {
        try {
            ...
            const valores = {
                ...
                ventaAhorro: this.util.formatCurrencyWithTaxes(data.cotiza.Euro.casa176.venta._text),
            }
            res.send(valores)
        } catch (e) {
            console.log(e)
    ...
    getEuroGalicia = async (_req, res) => {
        try {
            ...
            const valores = {
                ...
                ventaAhorro: this.util.formatCurrencyWithTaxes(data.cotiza.Euro.casa356.venta._text),
            }
            res.send(valores)
        } catch (e) {
            console.log(e)
    ...
    getEuroBBVA = async (_req, res) => {
        try {
            ...
            const valores = {
                ...
                ventaAhorro: this.util.formatCurrencyWithTaxes(data.cotiza.Euro.casa358.venta._text),
            }
            res.send(valores)
        } catch (e) {
            console.log(e)
    ...
    getEuroPampa = async (_req, res) => {
        try {
            ...
            const valores = {
                ...
                ventaAhorro: this.util.formatCurrencyWithTaxes(data.cotiza.Euro.casa359.venta._text),
            }
            res.send(valores)
        } catch (e) {
            console.log(e)
    ...
    getEuroChaco = async (_req, res) => {
        try {
            ...
            const valores = {
                ...
                ventaAhorro: this.util.formatCurrencyWithTaxes(data.cotiza.Euro.casa360.venta._text),
            }
            res.send(valores)
        } catch (e) {
            console.log(e)
    ...
    getEuroHipotecario = async (_req, res) => {
        try {
            ...
            const valores = {
                ...
                ventaAhorro: this.util.formatCurrencyWithTaxes(data.cotiza.Euro.casa361.venta._text),
            }
            res.send(valores)
        } catch (e) {
            console.log(e)
     ...
     getEuroPiano = async (_req, res) => {
        try {
            ...
            const valores = {
                ...
                ventaAhorro: this.util.formatCurrencyWithTaxes(data.cotiza.Euro.casa443.venta._text),
            }
            res.send(valores)
        } catch (e) {
            console.log(e)
    ...
    getEuroSantander = async (_req, res) => {
        try {
            ...
            const valores = {
                ...
                ventaAhorro: this.util.formatCurrencyWithTaxes(data.cotiza.Euro.casa447.venta._text),
            }
            res.send(valores)
        } catch (e) {
            console.log(e)
     ...
     getEuroCiudad = async (_req, res) => {
        try {
            ...
            const valores = {
                ...
                ventaAhorro: this.util.formatCurrencyWithTaxes(data.cotiza.Euro.casa448.venta._text),
            }
            res.send(valores)
        } catch (e) {
            console.log(e)
     ...
     getEuroSupervielle = async (_req, res) => {
        try {
            ...
            const valores = {
                ...
                ventaAhorro: this.util.formatCurrencyWithTaxes(data.cotiza.Euro.casa450.venta._text),
            }
            res.send(valores)
        } catch (e) {
            console.log(e)
     ...
     getEuroPatagonia = async (_req, res) => {
        try {
            ...
            const valores = {
                ...
                ventaAhorro: this.util.formatCurrencyWithTaxes(data.cotiza.Euro.casa454.venta._text),
            }
            res.send(valores)
        } catch (e) {
            console.log(e)
     ...
     getEuroComafi = async (_req, res) => {
        try {
            ...
            const valores = {
                ...
                ventaAhorro: this.util.formatCurrencyWithTaxes(data.cotiza.Euro.casa455.venta._text),
            }
            res.send(valores)
        } catch (e) {
            console.log(e)
     ...
     getEuroRebanking = async (_req, res) => {
        try {
            ...
            const valores = {
                ...
                ventaAhorro: this.util.formatCurrencyWithTaxes(data.cotiza.Euro.casa456.venta._text),
            }
            res.send(valores)
        } catch (e) {
            console.log(e)
    ...
    getEvolucionEuroAhorro = async (_req, res) => {
        try {
            const data = await this.dolarSiService.getInfoDolar()
            const valores = this.util.getEvolucionWithTaxes(data.cotiza.evolucion_dolar.euro.anio)
